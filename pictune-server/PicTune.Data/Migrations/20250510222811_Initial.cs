    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusicFilePlaylist", x => new { x.PlaylistsId, x.SongsId });
                    table.ForeignKey(
                        name: "FK_MusicFilePlaylist_MusicFiles_SongsId",
                        column: x => x.SongsId,
                        principalTable: "MusicFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MusicFilePlaylist_Playlists_PlaylistsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MusicFilePlaylist_SongsId",
                table: "MusicFilePlaylist",
                column: "SongsId");
