...
export default function AuthForm({
  ...
  onAuthSubmit: AuthFormProps["onAuthSubmit"]
}) {
  ...
  const handleCheckboxChange = (name: string, checked: boolean) => {
    ...
    if (name === "acceptTerms" && errors.acceptTerms) setErrors({ ...errors, acceptTerms: "" })
  }
  ...
  const passwordStrength = (() => {
    ...
    return { strength, label: strength > 0 ? labels[strength - 1] : "" }
  })()
